...
namespace QIQO.Monitor.Service
{
    public class Server : IModel
    {
        ...
        public Server(ServerData serverData, List<Service> services) : this(serverData)
        {
            Services = services;
        }
        ...
        public Server(int serverKey, string serverName, List<Service> services): this(serverKey, serverName)
        {
            Services = services;
        }
