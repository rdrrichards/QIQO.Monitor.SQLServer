...
{
    public class OpenTransactionRepository : ReadRepositoryBase<OpenTransactionData>, IOpenTransactionRepository
    {
        private readonly ISqlServerDbContext entityContext;

        public OpenTransactionRepository(ISqlServerDbContext dbc, IOpenTranactionMap map) : base(map)
        {
            entityContext = dbc;
        }
