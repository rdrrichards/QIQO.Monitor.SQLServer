...
namespace QIQO.Monitor.Client
{
    ...
    public class EnvironmentsController : ControllerBase
    {
        ...
        [HttpGet]
        public ActionResult<IEnumerable<Client.Environment>> Get()
        {
            try
            {
        ...
        /// <returns>500 - Internal Error</returns>
        [HttpGet("{id}")]
        public ActionResult<Client.Environment> Get(int id)
        {
            try
            {
        ...
        /// <returns>500 - Internal Error</returns>
        [HttpPost()]
        public ActionResult<Client.Environment> Post([FromBody] EnvironmentAdd environment)
        {
        ...
        /// <returns>500 - Internal Error</returns>
        [HttpPut("{id}")]
        public ActionResult<Client.Environment> Put(int id, [FromBody] EnvironmentUpdate environment)
        {
            if (environment == null) return BadRequest("Invalid environment parameter");
            try
            {
